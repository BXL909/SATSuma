...
namespace WinForms_NumUpDown
{
    ...
    public class CustomUpDown : Control
    {
        ...
        [Category("CustomUpDown"), 
         Description("Gets or sets the textbox back color (default White), 
        ...
        [Category("CustomUpDown"), 
         Description("Gets or sets the optional label text 
         (with ForeColor as the color)"), 
         RefreshProperties(RefreshProperties.Repaint)]
        ...
        /// </summary>
        private string plus2IconCode = "89 50 4E 47 0D 0A 1A 0A 00 00 00 
        ...
        C3 01 C7 6F A8 64 00 00 00 58 49 44 41 54 48 4B ED 93 51 0A 00 21 
        ...
        A3 42 AC EA C3 51 E7 D1 47 04 44 46 46 CC 70 10 B4 BC EC 4F 89 5F CE 
        ED 1D 1E 2D 63 41 CA 91 1A A5 89 A3 10 9D C5 09 CB 4E F0 23 DC D3 A6 
        8E D9 F1 DB 27 E9 2E C7 EC 56 1C DB 61 87 ED 40 E4 2F CA D3 30 3D C3 
        2A 06 23 00 00 00 00 49 45 4E 44 AE 42 60 82";
